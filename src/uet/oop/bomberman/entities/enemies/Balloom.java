...
public class Balloom extends AnimatedEntity {
    ...
    public Sprite changeImage() {
        switch (direction) {
            case "left": // left
                return Sprite.movingSprite(Sprite.balloom_left1
                        , Sprite.balloom_left2 , Sprite.balloom_left3 , getAnimate() , 24);
            case "right": // right
                return Sprite.movingSprite(Sprite.balloom_right1
                        , Sprite.balloom_right2 , Sprite.balloom_right3 , getAnimate() , 24);
            case "up": // up
                return Sprite.movingSprite(Sprite.balloom_left1
                        , Sprite.balloom_left2 , Sprite.balloom_left3 , getAnimate() , 24);
            case "down": // down
