...
/**
 * This class contains the images ( sprites ) -> sprites.getFxImage() to get the image ( from the SpriteSheet.classic.png)
 * This class also contains the movingSprites class -> to get other imgs when you move
 */
public class Sprite {
    ...
    public static Sprite powerup_health = new Sprite(DEFAULT_SIZE, 8, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite powerup_invincibility = new Sprite(DEFAULT_SIZE, 6, 10, SpriteSheet.tiles, 16, 16);
    ...
    public static Sprite door_close = new Sprite(SCALED_SIZE, 0, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open = new Sprite(SCALED_SIZE, 1, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open1 = new Sprite(SCALED_SIZE, 2, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open2= new Sprite(SCALED_SIZE, 3, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open3 = new Sprite(SCALED_SIZE, 4, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open4 = new Sprite(SCALED_SIZE, 5, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open5 = new Sprite(SCALED_SIZE, 6, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open6 = new Sprite(SCALED_SIZE, 7, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open7 = new Sprite(SCALED_SIZE, 8, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open8 = new Sprite(SCALED_SIZE, 9, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open9 = new Sprite(SCALED_SIZE, 10, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open10 = new Sprite(SCALED_SIZE, 11, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open11 = new Sprite(SCALED_SIZE, 12, 0, SpriteSheet.door, 32, 32);
    public static Sprite door_open12 = new Sprite(SCALED_SIZE, 13, 0, SpriteSheet.door, 32, 32);
    ...
    public static Sprite key = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.key, 16, 16);
    public static Sprite key1 = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.key, 16, 16);
    public static Sprite key2 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.key, 16, 16);
    public static Sprite key3 = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.key, 16, 16);
    public static Sprite key4 = new Sprite(DEFAULT_SIZE, 4, 0, SpriteSheet.key, 16, 16);
    public static Sprite key5 = new Sprite(DEFAULT_SIZE, 5, 0, SpriteSheet.key, 16, 16);
    ...
    public Image getFxImage() {
        ...
        return resample(input, SCALED_SIZE / getSize());
    }
